...
func (fake *FakeBuildStarterDB) GetNextPendingBuild(job string) (db.Build, bool, error) {
...
func (fake *FakeBuildStarterDB) GetNextPendingBuildCallCount() int {
...
func (fake *FakeBuildStarterDB) GetNextPendingBuildArgsForCall(i int) string {
	fake.getNextPendingBuildMutex.RLock()
	defer fake.getNextPendingBuildMutex.RUnlock()
	return fake.getNextPendingBuildArgsForCall[i].job
}

func (fake *FakeBuildStarterDB) GetNextPendingBuildReturns(result1 db.Build, result2 bool, result3 error) {
...
func (fake *FakeBuildStarterDB) SetMaxInFlightReached(jobName string, reached bool) error {
...
func (fake *FakeBuildStarterDB) SetMaxInFlightReachedCallCount() int {
...
func (fake *FakeBuildStarterDB) SetMaxInFlightReachedArgsForCall(i int) (string, bool) {
	fake.setMaxInFlightReachedMutex.RLock()
	defer fake.setMaxInFlightReachedMutex.RUnlock()
	return fake.setMaxInFlightReachedArgsForCall[i].jobName, fake.setMaxInFlightReachedArgsForCall[i].reached
}

func (fake *FakeBuildStarterDB) SetMaxInFlightReachedReturns(result1 error) {
...
func (fake *FakeBuildStarterDB) GetRunningBuildsBySerialGroup(jobName string, serialGroups []string) ([]db.Build, error) {
...
func (fake *FakeBuildStarterDB) GetRunningBuildsBySerialGroupCallCount() int {
...
func (fake *FakeBuildStarterDB) GetRunningBuildsBySerialGroupArgsForCall(i int) (string, []string) {
	fake.getRunningBuildsBySerialGroupMutex.RLock()
	defer fake.getRunningBuildsBySerialGroupMutex.RUnlock()
...
func (fake *FakeBuildStarterDB) GetRunningBuildsBySerialGroupReturns(result1 []db.Build, result2 error) {
...
func (fake *FakeBuildStarterDB) GetNextPendingBuildBySerialGroup(jobName string, serialGroups []string) (db.Build, bool, error) {
	var serialGroupsCopy []string
	if serialGroups != nil {
		serialGroupsCopy = make([]string, len(serialGroups))
		copy(serialGroupsCopy, serialGroups)
...
func (fake *FakeBuildStarterDB) GetNextPendingBuildBySerialGroupCallCount() int {
...
func (fake *FakeBuildStarterDB) GetNextPendingBuildBySerialGroupArgsForCall(i int) (string, []string) {
	fake.getNextPendingBuildBySerialGroupMutex.RLock()
	defer fake.getNextPendingBuildBySerialGroupMutex.RUnlock()
...
func (fake *FakeBuildStarterDB) GetNextPendingBuildBySerialGroupReturns(result1 db.Build, result2 bool, result3 error) {
